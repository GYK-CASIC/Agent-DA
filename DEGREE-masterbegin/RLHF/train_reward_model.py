...
parser.add_argument("--train_path", default="RLHF/data/reward_datasets/sentiment_analysis/train.tsv", type=str, help="The path of train set.")
parser.add_argument("--dev_path", default="RLHF/data/reward_datasets/sentiment_analysis/dev.tsv", type=str, help="The path of dev set.")
parser.add_argument("--save_dir", default="RLHF/checkpoints/reward_model/sentiment_analysis", type=str, required=False,
                    help="The output directory where the model predictions and checkpoints will be written.")
parser.add_argument("--max_seq_len", default=512, type=int,
                    help="The maximum total input sequence length after tokenization. Sequences longer "
                         "than this will be truncated, sequences shorter will be padded.", )
parser.add_argument("--batch_size", default=5, type=int, help="Batch size per GPU/CPU for training.", )
...
parser.add_argument("--valid_steps", default=10, type=int, required=False, help="evaluate frequecny.")
