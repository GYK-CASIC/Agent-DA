#!/usr/bin/env python3
"""
Reinforcement Learning from Human Feedback Terminal version.
"""
import os
import time
import random
...
prompts = [
    '刚收到货，感觉',  # Just received the goods, feels
    '这部电影很',  # This movie is very
    '说实话，真的很',  # Honestly, it's really
    '这次购物总的来说体验很'  # Overall, the shopping experience is very
]


def respond_to_batch(model, queries, txt_len=20, top_k=0, top_p=1.0):
    """
    Generate answers based on the prompt.
...
def main():
    ...
    # add title
    table.title = (
        "[bold not italic]:robot:[/] Reinforcement Learning from Human Feedback - Terminal"
    )
